...
def OAS_Aerodynamics_V2(SW, AR, Kink, TR, Sweep, mesh_delta_left_x, mesh_delta_left_y, mesh_delta_left_z):
    ...
    return (LoD_Wing, CL_Wing_total, CL_dragPolar_fixed, CD_dragPolar_intp, CD_i_dragPolar_intp, 
...
def OAS_Structure_V2(SW, AR, Kink, TR, Sweep, loads):
...
def OAS_Iteration_V2(SW, AR, Kink, TR, Sweep):
